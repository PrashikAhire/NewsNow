...
const App =()=> { 
  const pageSizes =  5;
  const apiKey = process.env.REACT_APP_NEWS_KEY5;
  ...
  const [progress, setProgress] = useState(0)
    ...
    return (
      ...
      <Navbar/>
        <Routes>
      <Route exact path="/" element={<News setProgress = {setProgress} apiKey={apiKey} key="home" pageSize = {pageSizes} country ={'in'}  category = 'general'/>} />
